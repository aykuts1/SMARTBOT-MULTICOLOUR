...
TREND: EMA21'in EMA50'ye gore konumuyla belirlenir (EMA21 > EMA50 -> long,
EMA21 < EMA50 -> short). ALMA9 trend hesabinda KULLANILMIYOR -- sadece TP
bantlari icin hesaplanmaya devam ediyor.
...
def compute_all(df: pd.DataFrame, cfg: dict) -> pd.DataFrame:
    ...
    # trend: EMA21, EMA50'nin ustundeyse -> long, altindaysa -> short
