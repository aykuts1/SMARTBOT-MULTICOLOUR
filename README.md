...
- Bot her başladığında, Telegram'da o ana kadar **bekleyen** komutları
  (varsa) çalıştırmadan atlar — sadece bundan sonra gelenlere tepki
  verir. Bu, geçmişte gönderilmiş bir `/dur` gibi bir komutun, botun
  her yeniden başlamasında yeniden çalışıp botu anında durdurmasını
